...
export const VeryLightBlueTransparent = '#b5d7fc91'
...
export const CasinoLimeTransparentDarkMode = '#30a70cee'
...
export const CasinoWhite = 'rgba(255, 255, 255, 0.81)'
...
export const typographyOptions: TypographyVariantsOptions = {
  ...
  h1: { fontSize: '3.2rem', fontWeight: 500 }, // hero section title
  h2: { fontSize: '2.4125rem', fontWeight: 500 }, // other section title
